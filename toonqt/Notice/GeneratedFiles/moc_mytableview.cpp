...
#include "../details_notice/mytableview.h"
...
QT_MOC_LITERAL(1, 12, 10), // "dropInUrls"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 11), // "QList<QUrl>"
QT_MOC_LITERAL(4, 36, 4), // "urls"
QT_MOC_LITERAL(5, 41, 30), // "VerticalScrollBaScrollToBottom"
QT_MOC_LITERAL(6, 72, 22) // "VerticalScrollbarMoved"

    },
    "MyTableView\0dropInUrls\0\0QList<QUrl>\0"
    "urls\0VerticalScrollBaScrollToBottom\0"
    "VerticalScrollbarMoved"
};
...
void MyTableView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->dropInUrls((*reinterpret_cast< QList<QUrl>(*)>(_a[1]))); break;
        case 1: _t->VerticalScrollBaScrollToBottom((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 2: _t->VerticalScrollbarMoved((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (MyTableView::*_t)(QList<QUrl> );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyTableView::dropInUrls)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyTableView::dropInUrls(QList<QUrl> _t1)
{
