...
TNHttpGetUnConfirmFriendFeed::TNHttpGetUnConfirmFriendFeed()
{
...
void TNHttpGetUnConfirmFriendFeed::requestFinished(QNetworkReply* reply, const QByteArray data, const int statusCode)
{
	if (statusCode == 200)
	{
...
void TNHttpGetUnConfirmFriendFeed::GetJson(std::function<void(bool, QJsonObject)> callback, const TNPluginParamPtr &pluginParam,
	const QString & version)
{
	this->checkCallback = callback;
	QString baseUrl = pluginParam->str_new_contact_systoon_com + URL_GETUNCONFIRMFRIENDFEED;
	QUrl url(baseUrl);
	QUrlQuery query;
